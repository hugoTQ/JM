...
typedef struct storable_picture //chj 用于保存图像处理的结果
{
...
typedef struct decoded_picture_buffer
{
  ...
  unsigned      size;
  unsigned      used_size;
  unsigned      ref_frames_in_buffer;//chj fs中用做short-term reference的帧的个数
